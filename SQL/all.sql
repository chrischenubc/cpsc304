...
insert into VehicleType values('Mid-size','mid size vehicle ideally for 4 peope', 700, 120, 12, 350, 70, 12, 15);
insert into VehicleType values('3493  Reserve St','New York');
insert into VehicleType values('1579  Robson St','Seattle');
insert into VehicleType values('194  Yonge Street','Richmond');
insert into VehicleType values('280  Nelson Street','Burnaby');

insert into Vehicle values(060839453,'ka385r', 'Honda','Civic','2017','Grey', 21902, 'ForRent');
insert into Vehicle values(112348546,'SP323z', 'Honda','Civic','2000','White', 83100, 'ForRent');
insert into Vehicle values(115987938,'7f9693', 'Honda','Civic','2012','Grey', 31199, 'ForRent');
insert into Vehicle values(132977562,'Oe699f', 'Honda','Accord','2015','Black', 40967, 'ForSale');
insert into Vehicle values(132977562,'Qw332e', 'Honda','Accord','2013','White', 32010, 'ForRent');
insert into Vehicle values(060839453,'8q664C', 'Honda','Accord','2014','Dark Grey', 39778, 'ForRent');
insert into Vehicle values(099354543,'rE988z','Toyota','Camry','2017','Black', 67860, 'ForSale');
insert into Vehicle values(351565322,'PD564M','Toyota','Camry','2011','White', 35790, 'ForRent');
insert into Vehicle values(552455318,'Xq099D','Toyota','Camry','1980','Black', 89900, 'ForSale');
insert into Vehicle values(142519864,'Jm023R','Toyota','Camry','1997','Black', 12890, 'ForRent');
insert into Vehicle values(242518965,'jU4699','BMW','X5','2017','Black', 12890, 'ForRent');
insert into Vehicle values(141582651,'al270o','BMW','X3','2015','Black', 19809, 'ForRent');
insert into Vehicle values(011564812,'J4062C','BMW','X1','2013','Black', 12890, 'ForRent');
insert into Vehicle values(254099823,'ux202C','Mercedes','CLA','2013','White', 19023, 'ForRent');
insert into Vehicle values(356187925,'N9727G','Mercedes','GLE','2018','Black', 21908, 'ForRent');
insert into Vehicle values(489456522,'Ql302Z','Mercedes','G','2019','Black', 12890, 'ForRent', ');


--now add in the faculty
insert into VehicleType values (142519864,'I. Teach',20);
insert into VehicleType values (242518965,'James Smith',68);
insert into VehicleType values (141582651,'Mary Johnson',20);
insert into VehicleType values (011564812,'John Williams',68);
insert into VehicleType values (254099823,'Patricia Jones',68);
insert into VehicleType values (356187925,'Robert Brown',12);
insert into VehicleType values (489456522,'Linda Davis',20);
insert into VehicleType values (287321212,'Michael Miller',12);
insert into VehicleType values (248965255,'Barbara Wilson',12);
insert into VehicleType values (159542516,'William Moore',33);
insert into VehicleType values (090873519,'Elizabeth Taylor',11);
insert into VehicleType values (486512566,'David Anderson',20);
insert into VehicleType values (619023588,'Jennifer Thomas',11);
insert into VehicleType values (489221823,'Richard Jackson',33);
insert into VehicleType values (548977562,'Ulysses Teach',20);

--now add in the enrollments
insert into Equipment values (112348546,'Lift Gate', 'available', '3274  Silver St','Vancouver');
insert into Equipment values (112348546,'Lift Gate', 'rented', '3274  Silver St','Vancouver');
insert into Equipment values (112348546,'Lift Gate', 'not available', '3274  Silver St','Vancouver');
insert into Equipment values (112348546,'Ski rack', 'available', '3274  Silver St','Vancouver');
insert into Equipment values (112348546,'Ski rack', 'rented', '3274  Silver St','Vancouver');
insert into Equipment values (112348546,'Ski rack', 'not available', '3274  Silver St','Vancouver');
insert into Equipment values (112348546,'Safety seat belts', 'available', '3274  Silver St','Vancouver');
insert into Equipment values (112348546,'Ski rack', 'available', '3274  Silver St','Vancouver');
insert into Equipment values (112348546,'LiftGate', 'available', '3274  Silver St','Vancouver');
insert into Equipment values (112348546,'LiftGate', 'available', '3274  Silver St','Vancouver');
insert into Equipment values (112348546,'LiftGate', 'available', '3274  Silver St','Vancouver');
insert into Equipment values (112348546,'LiftGate', 'available', '3274  Silver St','Vancouver');
insert into Equipment values (112348546,'LiftGate', 'available', '3274  Silver St','Vancouver');
